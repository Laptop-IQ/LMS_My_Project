export const bannerStyles = {
  ...
  container:
    "relative md:pt-25 xl:pt-25 pt-21 sm:min-h-[520px] md:min-h-[560px] lg:min-h-[600px] pt-6 sm:pt-20 lg:pt-25 flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 py-8 bg-gradient-to-br from-blue-50 via-white to-purple-50 animate-gradient-bg",
  ...
  // Main content
  mainContent:
    "max-w-6xl w-full mx-auto bg-white/70 backdrop-blur-lg shadow-xl border border-white/30 relative z-10 p-6 sm:p-8 lg:p-12 animate-fade-in",
  ...
  // Badge
  badge:
    "inline-flex items-center gap-2 px-4 py-2 bg-blue-100 text-blue-600 text-sm font-semibold animate-fade-in",
  badgeIcon: "w-4 h-4 text-blue-500",

  // Heading
  heading:
    "text-3xl sm:text-4xl lg:text-5xl uppercase tracking-wider leading-tight",
  headingSpan1:
  ...
  videoModal: {
    ...
    container:
      "relative w-[90%] max-w-3xl aspect-video overflow-hidden shadow-2xl border border-white/20",
    iframe: "w-full h-full",
    closeButton:
      "absolute top-3 cursor-pointer right-3 bg-white/90 hover:bg-white text-black font-bold p-2 shadow-lg transition-all duration-200",
    closeIcon: "w-5 h-5",
  },

  // Description
  description:
    "text-lg sm:text-xl font-body font-[pacifico] font-semibold text-gray-700 leading-relaxed mt-2 sm:mt-4",
  ...
  featureIcon: "text-sm",
  featureText: "text-gray-700 text-sm sm:text-base",

  // Buttons
  buttonsContainer:
    "flex flex-col sm:flex-row gap-3 sm:gap-4 pt-3 animate-fade-in opacity-0 animation-delay-900",
  buttonGetStarted:
    "px-6 py-3 sm:px-8 sm:py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold shadow-lg hover:shadow-blue-300 border border-black transition-all duration-300 transform text-sm sm:text-base text-center",
  buttonViewDemo:
    "px-6 py-3 sm:px-8 sm:py-3 bg-gradient-to-r from-blue-50 to-purple-100 hover:shadow-blue-400 cursor-pointer text-gray-700 font-semibold border border-blue-200 shadow-sm hover:shadow-md transition-all duration-300 transform text-sm sm:text-base text-center",

  // Image
  imageContainer: "flex items-center justify-center",
  image:
    "w-full max-w-[220px] sm:max-w-sm md:max-w-md lg:max-w-sm h-auto rounded-xl shadow-2xl border border-white/70 animate-float",
};
...
export const aboutUsStyles = {
  ...
  // Trust Badge
  trustBadge: "inline-flex items-center px-6 py-3 bg-white/10 text-white text-lg mb-8 backdrop-blur-sm border border-white/30 shadow-sm",
  ...
  inlineHighlight: "inline-block ml-2 px-2 py-1 text-blue-100 font-semibold",
  
  // Stats
  statsGrid: "grid grid-cols-2 md:grid-cols-4 gap-6 max-w-2xl mx-auto",
  statCard: "text-center p-4 bg-white/20 backdrop-blur-sm border border-white/20",
  ...
  sectionContent: "",
  sectionBadge: "inline-flex items-center px-4 py-2 bg-white shadow-lg mb-6",
  ...
  featureIcon: "w-8 h-8 bg-gradient-to-r flex items-center justify-center flex-shrink-0 transition-transform",
  ...
  valuesBadge: "inline-flex items-center px-6 py-3 bg-white shadow-lg mb-6",
  ...
  valueCard: "bg-white p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-3 group border border-gray-100 relative overflow-hidden",
  ...
  valueFeatureDot: "w-2 h-2 bg-gradient-to-r",
  valueUnderline: "absolute bottom-0 left-0 w-0 group-hover:w-full h-1 bg-gradient-to-r transition-all duration-500",
  
  // Team Section
  teamSection: "py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-100 to-indigo-100",
  ...
  teamImage: "w-48 h-48 mx-auto transform transition-all duration-500",
  ...
  testimonialCard: "bg-gray-50 p-8 hover:shadow-2xl transition-all duration-300 group border border-gray-100",
  ...
  testimonialAvatar: "w-12 h-12 object-cover",
  ...
  ctaOrb1: "absolute top-0 left-0 w-72 h-72 bg-white/50 -translate-x-1/2 -translate-y-1/2 animate-pulse",
  ctaOrb2: "absolute bottom-0 right-0 w-96 h-96 bg-white/50 translate-x-1/2 translate-y-1/2 animate-pulse animation-delay-2000",
  ...
  ctaButton: "group bg-transparent cursor-pointer border-2 border-white text-white px-12 py-5 font-bold text-lg hover:bg-white/10 transition-all duration-300 flex items-center gap-3 backdrop-blur-sm hover:shadow-2xl",
...
export const contactStyles = {
  // Layout & Container
  container: "bg-gradient-to-br from-white to-gray-100 py-10 px-4 sm:px-6 md:px-10 lg:px-12 overflow-x-hidden",
  mainContainer: "max-w-5xl mx-auto",
  
  // Header
  header: "text-center mb-12 sm:mb-16",
  title: "text-2xl sm:text-4xl md:text-5xl inline-flex items-center space-x-2 mt-15 px-4 sm:px-6 py-2 sm:py-3 border-2 border-purple-100 font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent font-['Poppins']",
  
  // Main Section
  mainSection: "grid grid-cols-1 font-serif lg:grid-cols-2 md:grid-cols-2 md:gap-2 gap-10 lg:gap-32 items-center",
  
  // Contact Form
  formContainer: "relative order-2 lg:order-2",
  formGlow1: "absolute -inset-1 bg-gradient-to-r from-purple-300 to-blue-500 opacity-75 blur-sm animate-pulse",
  formGlow2: "absolute -inset-1 bg-gradient-to-r from-purple-300 to-blue-500 opacity-50 animate-pulse delay-75",
  formGlow3: "absolute -inset-1 bg-gradient-to-r from-purple-300 to-blue-500 opacity-25 animate-pulse delay-150",
  form: "relative bg-white shadow-lg p-2 sm:p-8 border border-gray-100",
  ...
  input: "w-full px-4 py-3 border border-gray-300 focus:ring-2 focus:border-transparent transition-all duration-300 bg-white",
  inputError: "border-red-500",
  errorText: "mt-2 text-sm text-red-600",
  textarea: "w-full px-4 py-3 border border-gray-300 focus:ring-2 focus:border-transparent transition-all duration-300 bg-white group-hover:border-blue-400 resize-none",
  select: "w-full px-4 py-3 border border-gray-300 focus:ring-2 focus:border-transparent transition-all duration-300 bg-white group-hover:border-purple-400",
  ...
  // Submit Button
  submitButton: "w-full py-4 px-6 font-bold text-white transition-all duration-300 flex items-center justify-center",
  ...
  spinner: "w-5 h-5 border-t-2 border-white animate-spin mr-2",
  submitIcon: "w-5 h-5 mr-2",
  
  // Animation Section
  animationContainer: "relative order-1 xl:order-2 lg:order-2 w-full flex justify-center items-center",
  animationWrapper: "relative max-w-md sm:max-w-lg md:max-w-xl lg:max-w-full xl:max-w-full overflow-hidden",
  
  // Footer Info
  footer: "mt-12 sm:mt-16 text-center",
  footerBadge: "inline-flex items-center space-x-2 bg-gradient-to-r from-purple-50 to-blue-50 px-4 sm:px-6 py-2 sm:py-3 border border-purple-100",
...
export const coursePageStyles = {
  ...
  searchGradient:
    "absolute -inset-1 bg-gradient-to-r from-purple-500 via-blue-500 to-indigo-500 blur-lg opacity-20 group-hover:opacity-60 transition-opacity duration-700 animate-gradient-x",
  searchInputContainer:
    "relative bg-white/80 backdrop-blur-lg border border-transparent group-hover:border-blue-400 shadow-xl transition-all duration-500",
  searchIconContainer:
  ...
  searchInput:
    "w-full pl-12 pr-10 py-3 bg-transparent text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-0 font-medium text-sm sm:text-base",
  clearButton:
  ...
  noCoursesButton:
    "mt-4 px-6 py-3 bg-blue-500 text-white hover:bg-blue-600 transition-colors w-full sm:w-auto",

  // Courses grid
  coursesGrid: "max-w-5xl mx-auto font-[pacifico] relative z-10",
  coursesGridContainer:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 sm:gap-8 lg:gap-3",
  ...
  courseCardContent:
    "backdrop-blur-lg p-1 shadow-2xl border border-white/40 transform translate-z-0 h-full flex flex-col bg-white/60 overflow-hidden",

  // Course image
  courseImageContainer: "relative overflow-hidden",
  courseImage:
...
export const myCoursesStyles = {
  ...
  // Course card
  courseCard:
    "group bg-white/80 backdrop-blur-sm p-1 shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-white/50 cursor-pointer",
  imageContainer: "relative overflow-hidden",
  courseImage:
    "w-full h-48 object-contain pb-5.5 lg:pb-6 xl:pb-7.5 transition-transform duration-700",
  courseContent: "p-2",

  // Course info
  courseName: "text-lg font-bold text-gray-800 mb-3 line-clamp-1 transition-colors duration-300",
  infoContainer: "flex items-center justify-between mb-4",

  // Rating
  ratingContainer: "inline-flex space-x-1 gap-2 bg-yellow-50 border border-yellow-100 rounded-xl px-12 py-1",
  ratingIcon: "w-6 h-6 text-yellow-500 fill-current",
  ratingText: "text-sm font-semibold text-gray-800 leading-none",

  // Teacher
  teacherContainer: "flex items-center space-x-1 mb-2",
  teacherIcon: "w-5 h-5 text-blue-600",
  teacherText: "text-sm font-medium text-gray-800 truncate max-w-[80px]",

  // Button
  viewButton:
    "w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold py-3 px-4 transition-all duration-300 transform shadow-lg hover:shadow-xl flex items-center justify-center space-x-2 cursor-pointer group/btn",
  buttonIcon:
...
export const facultyStyles = {
  // Layout & Container
  container: "pt-12 sm:pt-5 bg-gradient-to-br from-blue-50 via-white to-purple-50",
  ...
  titleDivider:
    "w-20 sm:w-28 h-1 bg-gradient-to-r from-blue-200 to-sky-500 mx-auto mb-4",
  subtitle:
    "text-base sm:text-lg md:text-xl text-blue-500 max-w-2xl mx-auto leading-relaxed",

  // Faculty Grid
  facultySection: "py-1 px-4 sm:px-6 lg:px-8",
  ...
  card: "group",
  teacherCard:
    "bg-white shadow-xl hover:shadow-2xl transition-all duration-500 p-4 sm:p-6 border-2 border-gray-200 hover:border-purple-300",

  // Image Section
  imageContainer: "relative mb-4 sm:mb-6",
  imageWrapper:
    "w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 mx-auto overflow-hidden",
  image:
    "w-full h-full object-cover border-4 border-white shadow-inner",

  // Experience Badge
  experienceBadge: "absolute -bottom-3 left-1/2 transform -translate-x-1/2",
  experienceBadgeContent:
    "bg-gradient-to-r from-green-500 to-emerald-600 text-white px-3 py-1 text-xs sm:text-sm font-semibold shadow-lg",
  ...
  starButton:
    "transition-all duration-200 transform hover:scale-125 p-1 focus:outline-none focus:ring-2 focus:ring-indigo-200",
  ...
  socialIcon:
    "transform transition-all duration-300 hover:scale-105 hover:-translate-y-1 p-3 sm:p-3.5 shadow-lg hover:shadow-xl",
...
export const footerStyles = {
  ...
  container: "relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-16",
  
  // Grid layout
  grid: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5 sm:gap-12 mb-2 sm:mb-3",
  ...
  contactItem: "flex items-center group transform transition-all duration-300 p-3",
  contactIconContainer: "flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center mr-3 sm:mr-4 transform transition-transform duration-300 shadow-lg border border-white overflow-hidden",
  contactIcon: "w-4 h-4",
  ...
  // Social section
  socialSection: "border-t border-slate-200/60 pt-2",
...
export const homeCoursesStyles = {
  ...
  // Courses Grid
  coursesGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-4 mt-10",

  // Course Card
  courseCard: "group bg-white/70 overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 cursor-pointer",
  imageContainer: "relative overflow-hidden px-1 -mt-",
  courseImage: "w-full h-48 object-contain pb-5.5 lg:pb-6 xl:pb-7.5 transition-transform duration-700",
  courseContent: "p-2",

  // Course Info
  courseInfo: "mt-4 px-3 -translate-y-3 sm:-translate-y-5 space-y-2 py-3",
  ...
  ctaGlow: "absolute -inset-1 border-1 pointer-events-none border-anim",
  ctaButton: "relative z-10 inline-flex items-center gap-4 px-12 py-4 text-xl font-bold bg-white/10 text-white transform transition duration-300 cursor-pointer active:scale-95 focus:outline-none",
...
export const navbarStyles = {
  ...
  // Desktop Navigation
  desktopNav: "hidden lg:flex items-center justify-center flex-1 max-w-3xl",
  desktopNavContainer:
    "flex items-center space-x-1 bg-white/80 backdrop-blur-sm p-3 shadow-sm border border-gray-200",
  desktopNavItem:
    "group relative px-3 py-2 transition-all duration-300 flex items-center space-x-2",
  desktopNavItemActive:
    "bg-gradient-to-r from-blue-50 to-indigo-100 text-blue-600 shadow-md",
  desktopNavIcon:
  ...
  mobileMenu: "fixed top-0 right-0 h-full w-72 bg-white/95 backdrop-blur-xl shadow-2xl border-l border-gray-200 transform transition-transform duration-500 z-50",
  mobileMenuOpen: "translate-x-0",
  mobileMenuClosed: "translate-x-full",
  mobileMenuContainer: "bg-white/90 backdrop-blur-xl p-4 shadow-lg border border-gray-200",
  mobileMenuItems: "space-y-2",
  mobileMenuItem: "flex items-center space-x-3 p-3 transition-all duration-300",
  ...
  // Mobile Auth Buttons
  mobileLoginButton: "w-full flex items-center justify-center space-x-2 p-3 bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-semibold shadow-sm hover:shadow-md transition-all duration-300 mt-2",
  mobileLogoutButton: "w-full flex items-center justify-center space-x-2 p-3 bg-white text-gray-800 font-semibold shadow-sm border border-gray-200 hover:shadow-md transition-all duration-300 mt-2",
...
export const testimonialStyles = {
  ...
  // Header
  badge: "inline-flex items-center gap-3 px-4 py-2 bg-white/80 backdrop-blur-sm border border-indigo-100 mb-4 sm:mb-6",
  badgeDot: "w-3 h-3 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full animate-pulse",
  ...
  glowBorder: "absolute -inset-2 bg-gradient-to-r from-indigo-400/30 via-pink-400/20 to-purple-400/30 blur-xl opacity-60 transition-all duration-700 pointer-events-none",
  backgroundPattern: "absolute inset-0 bg-gradient-to-br from-white/85 to-indigo-50/30 backdrop-blur-sm border border-white/50 pointer-events-none",
  
  // Floating Elements
  floatingElement1: "absolute -left-4 -top-4 w-16 h-16 bg-gradient-to-br from-pink-200/40 to-purple-200/40 blur-xl animate-float-slow pointer-events-none hidden sm:block",
  floatingElement2: "absolute -right-6 -bottom-6 w-20 h-20 bg-gradient-to-br from-indigo-200/40 to-blue-200/40 blur-xl animate-float pointer-events-none hidden sm:block",
  
  // Main Card
  card: "relative z-10 bg-white/70 backdrop-blur-md p-6 sm:p-8 transform transition-all duration-300 card-init hover:shadow-2xl will-change-transform border border-white/60 overflow-hidden",
  cardShadow: "0 20px 60px rgba(16,24,40,0.08), 0 0 0 1px rgba(255,255,255,0.4)",
  
  // Course Badge
  courseBadge: "course-badge inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-200/50 mb-4 sm:mb-6",
  courseBadgeDot: "w-2 h-2 bg-gradient-to-r from-indigo-500 to-purple-500",
  ...
  avatarWrapper: "relative w-full h-full rounded-xl overflow-hidden",
...
export const courseDetailStyles = {
  // Layout & Container
  container: "min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 py-4 px-4 relative overflow-hidden",
  mainContainer: "max-w-7xl mx-auto space-y-1 relative z-10 transition-all duration-1000",
  containerVisible: "opacity-100 translate-y-0",
  containerHidden: "opacity-0 translate-y-8",
  
  // Back Button
  backButton: "inline-flex cursor-pointer items-center gap-2 px-4 py-2 bg-white/70 backdrop-blur-md shadow-lg hover:shadow-xl transition-all duration-300 border border-white/50 hover:border-white/80 animate-slideInLeft",
  backIcon: "w-5 h-5",
  backText: "font-medium",
  
  // Course Header
  header: "text-center space-y-6 relative",
  badge: "inline-flex items-center gap-2 px-6 py-3 bg-white/60 backdrop-blur-sm shadow-lg border border-white/50 animate-bounceIn",
  badgeIcon: "w-5 h-5",
  ...
  overview: "p-6 font-serif bg-white/40 backdrop-blur-md shadow-xl border border-white/50 hover:border-white/80 transition-all duration-500 animate-slideInUp",
  ...
  statItem: "flex items-center gap-3 text-gray-700 bg-white/50 backdrop-blur-sm px-4 py-2 border border-white/50",
  statIcon: "w-5 h-5 text-indigo-600",
  statText: "font-medium",
  teacherStat: "flex items-center gap-3 text-gray-700 bg-white/50 backdrop-blur-sm px-4 py-2 border border-white/50 transition-all duration-1000",
  ...
  // Video Player
  videoSection: "xl:col-span-2 space-y-2",
  videoContainer: "bg-white/70 backdrop-blur-md shadow-2xl overflow-hidden border border-white/50 hover:border-white/80 transition-all duration-500 animate-slideInRight",
  video: "w-full h-[500px] object-cover bg-black",
  iframe: "w-full h-[500px]",
  videoPlaceholder: "w-full h-[500px] flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 text-white relative overflow-hidden",
  videoPlaceholderBg: "absolute inset-0 opacity-20",
  videoPlaceholderOrb1: "absolute top-1/4 left-1/4 w-32 h-32 bg-purple-500 mix-blend-overlay filter blur-xl",
  videoPlaceholderOrb2: "absolute bottom-1/4 right-1/4 w-32 h-32 bg-blue-500 mix-blend-overlay filter blur-xl",
  videoPlaceholderContent: "text-center relative z-10",
  videoPlaceholderIcon: "w-20 h-20 bg-white/10 flex items-center justify-center mx-auto mb-4 backdrop-blur-sm",
  ...
  durationBadge: "flex items-center gap-2 text-gray-500 bg-gray-100/50 px-3 py-1",
  durationIcon: "w-4 h-4",
  chapterBadge: "text-sm bg-indigo-100 text-indigo-700 px-3 py-1 border border-indigo-200/50",
  
  // Completion Button
  completionSection: "mt-6 pt-6 border-t border-gray-200/50",
  completionButton: "inline-flex cursor-pointer items-center gap-3 px-6 py-3 font-semibold transition-all duration-300 backdrop-blur-sm",
  ...
  // Course Content
  contentCard: "p-6 bg-white/70 backdrop-blur-md shadow-2xl border border-white/50 hover:border-white/80 transition-all duration-500 animate-slideInLeft",
  contentHeader: "flex items-center justify-between mb-6",
  contentTitle: "text-xl font-bold text-gray-800",
  freeBadge: "text-sm text-green-600 font-semibold bg-green-100 px-3 py-1 flex items-center gap-2",
  freeBadgeIcon: "w-4 h-4",
  contentList: "space-y-3 max-h-[600px] overflow-y-auto custom-scrollbar",
  
  // Lecture Item
  lectureItem: " bg-white/50 backdrop-blur-sm shadow-lg border border-white/50 hover:border-white/80 transition-all duration-300 animate-fadeInUp",
  ...
  lectureChapterCount: "text-xs bg-gray-100/50 px-2 py-1 border border-gray-200/50",
  
  // Chapter List
  chapterList: "p-4 pt-0 space-y-2 animate-fadeIn",
  chapterItem: "p-3 cursor-pointer transition-all duration-300 group",
  ...
  chapterDuration: "text-sm text-gray-500 bg-white/50 px-2 py-1 border border-white/50",
  
  // Pricing Card
  pricingCard: "p-6 bg-white/70 backdrop-blur-md shadow-2xl border border-white/50 hover:border-white/80 transition-all duration-500 animate-slideInLeft",
  ...
  discountBadge: "ml-auto text-sm bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 px-3 py-1 border border-green-200/50",
  pricingDescription: "text-sm text-gray-600 mb-6",
  
  // Enrollment Buttons
  enrollButton: "w-full inline-flex items-center justify-center gap-3 px-6 py-4 cursor-pointer font-semibold shadow-lg hover:shadow-xl transform transition-all duration-300 group disabled:opacity-70 disabled:cursor-not-allowed",
  ...
  enrollSpinner: "w-5 h-5 border-2 border-white border-t-transparent animate-spin",
  enrollIcon: "w-5 h-5 transition-transform",
  enrollArrow: "ml-auto opacity-80 group-hover:opacity-100",
  
  // Progress Card
  progressCard: "p-6 bg-white/70 backdrop-blur-md shadow-2xl border border-white/50 hover:border-white/80 transition-all duration-500 animate-slideInLeft",
  ...
  progressBar: "w-full bg-gray-200/50 h-3 backdrop-blur-sm",
  progressFill: "bg-gradient-to-r from-indigo-500 to-pink-500 h-3 transition-all duration-1000 ease-out shadow-inner",
  ...
  // Toast
  toast: "fixed top-6 right-6 p-4 shadow-2xl backdrop-blur-md transform transition-all duration-500 z-50 animate-slideInRight",
  ...
  notFoundButton: "mt-4 cursor-pointer inline-flex items-center gap-2 px-4 py-2 shadow-lg bg-white/10 backdrop-blur-md",
...
export const courseDetailStylesH = {
  ...
  courseBadge: "inline-flex items-center gap-2 px-6 py-3 bg-white/60 backdrop-blur-sm shadow-lg border border-white/50 animate-bounceIn",
  badgeIcon: "w-5 h-5",
  badgeText: "text-sm font-medium bg-gradient-to-r from-indigo-600 to-pink-500 bg-clip-text text-transparent",
  ...
  // Overview section
  overviewContainer: "max-w-4xl mx-auto",
  overviewCard: "p-6 font-serif bg-white/40 backdrop-blur-md shadow-xl border border-white/50 hover:border-white/80 transition-all duration-500 animate-slideInUp",
  overviewHeader: "flex items-center gap-3 mb-3",
  overviewIcon: "w-5 h-5 text-indigo-600",
  overviewTitle: "text-lg font-semibold text-gray-800",
  overviewText: "text-gray-700 text-base leading-relaxed text-left",
  ...
  videoFrame: "w-full h-[220px] sm:h-[320px] md:h-[420px] lg:h-[500px]",
  ...
  videoPlaceholderBlob: "absolute w-32 h-32 mix-blend-overlay filter blur-xl",
  ...
  durationBadge: "flex items-center gap-2 text-gray-500 bg-gray-100/50 px-3 py-1",
  durationIcon: "w-4 h-4",
  chapterBadge: "text-sm bg-indigo-100 text-indigo-700 px-3 py-1 border border-indigo-200",
  
  // Completion button
  completionSection: "mt-6 pt-6 border-t border-gray-200/50",
  completionButton: "inline-flex cursor-pointer items-center gap-3 px-6 py-3 font-semibold transition-all duration-300 backdrop-blur-sm hover:scale-105",
  completionButtonCompleted: "bg-green-500/20 text-green-700 hover:bg-green-500/30 border border-green-300/50 hover:border-green-400/50",
  completionButtonIncomplete: "bg-indigo-500/20 text-indigo-700 hover:bg-indigo-500/30 border border-indigo-300/50 hover:border-indigo-400/50",
  completionIcon: "w-5 h-5",
  completionText: "text-sm text-gray-500 mt-2",
  ...
  // Sidebar sections
  sidebar: "space-y-6",
  sidebarCard: "p-6 bg-white/70 backdrop-blur-md shadow-2xl border border-white/50 hover:border-white/80 transition-all duration-500",
  
  // Course content
  contentHeader: "flex items-center justify-between mb-6",
  contentTitle: "text-xl font-bold text-gray-800",
  freeAccessBadge: "text-sm text-green-600 font-semibold bg-green-100 px-3 py-1 flex items-center gap-2",
  ...
  lectureChaptersCount: "text-xs bg-gray-100/50 px-2 py-1 border border-gray-200/50",
  ...
  pricingDiscount: "ml-auto text-sm bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 px-3 py-1 border border-green-200/50",
  pricingDescription: "text-sm text-gray-600 mb-6",
  
  // Enroll button
  enrollButton: "w-full inline-flex cursor-pointer items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-indigo-500 to-pink-500 text-white font-semibold shadow-lg hover:shadow-xl transform transition-all duration-300 group disabled:opacity-70 disabled:cursor-not-allowed",
  enrollButtonFree: "w-full inline-flex items-center justify-center gap-3 px-6 py-2 sm:py-4 md:py-4 lg:py-4 xl:py-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold shadow-sm cursor-default group",
  enrollButtonEnrolled: "w-full inline-flex items-center justify-center gap-3 px-6 py-4 bg-white border border-green-300 text-green-700 font-semibold shadow-sm cursor-default group",
  ...
  progressBarContainer: "w-full bg-gray-200/50 h-3 backdrop-blur-sm",
  progressBar: "bg-gradient-to-r from-indigo-500 to-pink-500 h-3 transition-all duration-1000 ease-out shadow-inner",
  progressStats: "grid grid-cols-2 gap-4 text-center",
  progressStat: "p-4 bg-white/50 backdrop-blur-sm border border-white/50 hover:bg-white/70 transition-all duration-300",
  progressStatValue: "text-2xl font-bold bg-gradient-to-r from-indigo-600 to-pink-500 bg-clip-text text-transparent",
  progressStatLabel: "text-sm text-gray-600 mt-1",
  ...
  notFoundBlob: "absolute w-72 h-72 mix-blend-multiply filter blur-xl animate-blob",
  notFoundContent: "text-center relative z-10",
  notFoundTitle: "text-2xl font-bold",
  notFoundText: "mt-2 text-gray-500",
  notFoundButton: "mt-4 cursor-pointer inline-flex items-center gap-2 px-4 py-2 shadow-lg bg-white/10 backdrop-blur-md"
