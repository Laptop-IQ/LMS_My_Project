...
export const dashboardStyles = {
  ...
  statCard: "bg-gradient-to-br from-sky-50 to-sky-300 md:p-3 lg:p-5 xl:p-5 shadow-lg p-3 sm:p-6 transform transition-all duration-300 animate-slide-up",
  statTitle: "text-gray-600 text-sm sm:text-base font-medium mb-1",
  statValue: "text-2xl sm:text-3xl font-bold text-gray-800",
  statIconContainer: (color) => `${color} p-3 text-white`,
  statIcon: "w-5 h-5 sm:w-6 sm:h-6",

  // Courses section
  coursesContainer: "bg-white shadow-lg overflow-hidden animate-fade-in",
  ...
  searchInput: "pl-10 pr-4 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent w-full sm:w-64",
  ...
  // Course item styles
  courseImage: "w-16 h-12 sm:w-12 sm:h-10 object-cover mr-3 sm:mr-4 shadow-sm",
...
export const listStyles = {
  ...
  searchInput:
    "w-full pl-9 sm:pl-10 pr-4 py-2.5 sm:py-3 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-sky-300 focus:border-transparent bg-white shadow-sm text-sm sm:text-base",

  // Course list styles
  courseList: "space-y-3 sm:space-y-4",
  courseCard:
    "bg-white shadow-md border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-lg",
  ...
  courseImage:
    "w-16 h-12 sm:w-20 sm:h-16 lg:w-24 lg:h-16 object-cover shadow-sm flex-shrink-0",
  ...
  courseBadge: (courseType) =>
    `px-2 py-0.5 mb-4 text-xs font-semibold select-none self-start lg:mt-8 xl:mt-8 sm:self-auto ${
      courseType === "top"
  ...
  toggleButton:
    "p-1.5 sm:p-2 text-sky-300 hover:text-white hover:bg-sky-500 cursor-pointer transition-colors duration-200 flex items-center",
  deleteButton:
    "p-1.5 sm:p-2 text-gray-600 hover:text-red-600 hover:bg-red-50 transition-colors duration-200",
  ...
  // Lecture styles
  lectureCard: "bg-white border border-gray-100 overflow-hidden",
  ...
  chapterCard:
    "flex items-center justify-between p-2 sm:p-3 bg-white border border-gray-100",
  chapterContent: "flex-1 min-w-0",
  chapterHeader: "flex items-start gap-2 sm:gap-3",
  chapterIcon: "p-1.5 sm:p-2 bg-sky-100 shadow-xs flex-shrink-0 mt-0.5",
  ...
  editButton: "p-2 bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-lg",

  publishButton:
    "p-2 bg-green-100 hover:bg-green-200 text-green-600 rounded-lg",

  unpublishButton:
    "p-2 bg-yellow-100 hover:bg-yellow-200 text-yellow-600 rounded-lg",
...
export const addPageStyles = {
  ...
  headerTitle: "relative text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-sky-600 to-sky-800 bg-clip-text text-transparent mb-3 sm:mb-4",
  ...
  // Card styles
  card: "bg-white/80 backdrop-blur-lg sm:rounded-3xl p-4 sm:p-6 lg:p-8 border border-white/50 shadow-xl sm:shadow-2xl",
  ...
  cardIconContainer: "p-2 sm:p-3 bg-gradient-to-br from-sky-300 to-sky-600 shadow-lg",
  cardIcon: "text-white",
  ...
  courseTypeLabel: (isSelected, type) => 
    `flex items-center gap-2 sm:gap-3 p-3 sm:p-4 border-2 cursor-pointer transition-all duration-300 ${
      isSelected
        ? type === 'top' 
  ...
  input: "w-full px-3 sm:px-4 py-2 sm:py-3 bg-white border-2 border-gray-200 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 shadow-sm text-sm sm:text-base",
  textarea: "w-full px-3 sm:px-4 py-2 sm:py-3 bg-white border-2 border-gray-200 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 shadow-sm resize-none text-sm sm:text-base",
  ...
  uploadInput: "hidden",
  uploadBox: "w-full px-3 sm:px-4 py-3 sm:py-4 bg-gradient-to-br from-white to-gray-50 border-2 border-dashed border-gray-300 text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 group-hover:border-blue-400 group-hover:bg-blue-50 group-hover:text-blue-600 shadow-sm text-sm sm:text-base",
  uploadIcon: "transition-transform group-hover:scale-110",
  imagePreview: "w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 sm:rounded-2xl overflow-hidden border-2 border-white shadow-lg ring-2 ring-blue-200 flex-shrink-0",

  // Select input
  select: "w-full px-3 sm:px-4 py-2 sm:py-3 bg-white border-2 border-gray-200 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 shadow-sm appearance-none bg-gradient-to-b from-white to-gray-50 text-sm sm:text-base",

  // Lectures header
  lecturesHeader: "flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 sm:gap-0 mb-6 sm:mb-8",
  addLectureButton: "bg-gradient-to-r from-sky-300 to-sky-500 cursor-pointer hover:from-sky-400 hover:to-sky-500 text-white px-4 sm:px-6 py-2 sm:py-3 font-semibold transition-all duration-300 flex items-center gap-2 transform shadow-lg hover:shadow-xl text-sm sm:text-base w-full sm:w-auto justify-center",

  // Lectures list
  lecturesList: "space-y-3 sm:space-y-4",
  lectureCard: "bg-gradient-to-br from-white to-gray-50 sm:rounded-2xl p-4 sm:p-6 border border-gray-200/50 shadow-lg hover:shadow-xl transition-all duration-300",
  ...
  lectureToggleButton: "p-2 bg-blue-100 text-blue-600 hover:bg-sky-400 cursor-pointer transition-colors duration-200 flex-shrink-0",
  ...
  addChapterButton: "bg-gradient-to-r from-sky-300 to-sky-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 font-medium transition-all duration-300 flex items-center gap-2 cursor-pointer shadow-md text-xs sm:text-sm",
  deleteButton: "p-1.5 sm:p-2 text-red-400 hover:text-red-600 cursor-pointer hover:bg-red-50 transition-colors duration-200 ml-1 sm:ml-2",
  ...
  chapterCard: "bg-gradient-to-r from-purple-50 to-pink-50 sm:rounded-xl p-3 sm:p-4 border border-purple-100 shadow-sm",
  ...
  chapterDeleteButton: "p-1 text-red-400 hover:text-red-600 cursor-pointer hover:bg-red-50 transition-colors duration-200 ml-0 sm:ml-4 self-end sm:self-auto mt-2 sm:mt-0",

  // Submit button
  submitContainer: "text-center",
  submitButton: "bg-gradient-to-r from-sky-300 to-sky-600 cursor-pointer text-white px-8 sm:px-12 lg:px-16 py-3 sm:py-4 font-bold text-base sm:text-lg transition-all duration-300 transform shadow-2xl hover:shadow-3xl relative overflow-hidden group w-full sm:w-auto",

  // Modal styles
  modalOverlay: "fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 z-50",
  modal: "bg-white sm:rounded-3xl p-4 sm:p-6 lg:p-8 max-w-md w-full border border-white/50 shadow-2xl mx-2",
  modalHeader: "flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6",
  modalIconContainer: (color) => `p-2 ${color}`,
  ...
  modalButton: "flex-1 py-2 sm:py-3 font-semibold transition-all duration-300 flex items-center justify-center gap-2 shadow-lg text-sm sm:text-base",
  ...
  modalButtonCompact: "flex-1 py-2 sm:py-3 font-semibold transition-all duration-300 text-sm sm:text-base",
  ...
  chapterPreview: "bg-blue-50 p-2 sm:p-3 text-xs sm:text-sm border border-blue-100",
...
export const navbarStyles = {
  ...
  navInner: (isMenuOpen) => 
    `relative w-[90%] xl:rounded-full md:rounded-full sm:w-[90%] md:w-[95%] lg:w-[70%] xl:w-[90%] max-w-6xl mx-auto lg:rounded-full px-4 py-1 md:py-3 lg:py-3 xl:py-3 sm:py-3 backdrop-blur-md bg-white/60 border border-white/30 shadow-xl shadow-sky-600/8 transition-all duration-500`,

  // Glow effect
  glowEffect: "pointer-events-none absolute -inset-1 rounded-xl blur-[18px] opacity-30 bg-gradient-to-r from-blue-400 to-cyan-300 mix-blend-screen",
  ...
  desktopNavInner: "inline-flex items-center gap-2 bg-white/40 backdrop-blur-sm p-2 shadow-sm",
  desktopNavItem: (isActive) => 
    `relative flex items-center gap-2 cursor-pointer px-4 py-2 font-medium transition-all duration-300 transform group overflow-hidden ${
      isActive
  ...
  desktopActiveGlow: "absolute -inset-px pointer-events-none blur-sm opacity-80 bg-gradient-to-r from-blue-600 to-cyan-600 mix-blend-screen",
...
export const bookingsStyles = {
  ...
  searchInput: "w-full pl-10 pr-4 py-2 border border-sky-300 focus:outline-none focus:ring-2 focus:ring-sky-500 bg-sky-50 text-sky-900",

  // Bookings grid
  bookingsGrid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6",

  // Booking card
  bookingCard: "bg-white shadow-sm border border-sky-200 p-6 hover:shadow-md transition",

  // Student section
  studentSection: "flex items-center mb-4",
  studentIconContainer: "bg-sky-100 p-2",
  ...
  statusBadge: "inline-flex px-3 py-1 text-sm font-medium bg-green-100 text-green-800",

  // Empty state
  emptyState: "text-center py-12",
  emptyContainer: "bg-white p-8 max-w-md mx-auto",
